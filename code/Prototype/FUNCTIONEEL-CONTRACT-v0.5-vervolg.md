...
DVK toont niet alleen vrijgesteld/niet-vrijgesteld maar ook de grond. Onderscheid moet mogelijk blijven tussen onder meer eigen CKC-erkende functie/rol, recreatieve deelname, erelidmaatschap, de gezinsregel voor minderjarigen en de gezinsregel voor meerderjarigen: **een meerderjarig gezinslid op hetzelfde adres is vrijgesteld wanneer een mede-gezinslid op hetzelfde adres een CKC-erkende vrijstellende functie vervult**. Eventuele later vastgestelde vrijstellingsgronden blijven eveneens afzonderlijk verklaarbaar. Ontbrekende of ambigue bronfeiten worden niet gegokt.
